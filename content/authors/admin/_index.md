...
work:
  ...
  - position: Post-doctoral Researcher
    ...
    date_end: 2022-06-22
    summary: Researched the photic behaviour of sea urchins as part of an
      international HFSP collaboration. Designed and carried out behavioural
      experiments and performed statistical analysis.
  - position: Project Manager - Vision Research
    company_name: Lund University
    company_url: http://www.lu.se
    date_start: 2019-06-01
    date_end: 2019-08-31
    summary: Carried out vision science behavioural experiments and analysis using
      R, Matlab and Python.
  - position: Doctoral Researcher
    ...
    date_end: 2018-06-07
    summary: Wrote my PhD thesis 'Spatial Vision in Diverse Invertebrates' at the
      Lund Vision Group, Sweden.
...
awards:
  ...
  - title: Applied Software Engineering Fundamentals Specialization
    ...
    date: 2023-03-10
    summary: >
      Covers Git, GitHub, Linux, and Python, and learn the fundamentals of
...
summary: Computational biologist and data scientist with a track record of
  applying machine learning and statistical modelling to complex biological
  problems.
...
I am now looking to bring this skillset to health informatics and clinical data science, where the same analytical rigour can drive decisions with direct patient impact.